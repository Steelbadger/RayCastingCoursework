...
SoundSample::SoundSample(const char * Filename, AudioDevice * const pAD)
{
	m_Location = 0;
	m_Stream = NULL;
	m_FragSize = 0;
...
void SoundSample::Load(const char * Filename)
{
...
void SoundSample::PlayLoop(void)
{
	m_Loop = true;
	m_Location = 0;
	m_pAD->SetSoundSample(this);
